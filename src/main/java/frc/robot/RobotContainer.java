...
public class RobotContainer {
	...
	// Extra Buttons
	private final Trigger OPstartButton = new JoystickButton(OPERATOR, XboxController.Button.kStart.value);
	private final Trigger OPbackButton = new JoystickButton(OPERATOR, XboxController.Button.kBack.value);
	...
	private void configureButtonBindings() {
		...
		right.toggleOnTrue(new SourceIntake(pivot, shooter));
		...
		YButton.toggleOnTrue(shooter.rejectNote().alongWith(intake.enableReverseIntake()))
